...
rule : { (0,0) + 1 } 100 { (-1,-1,1) = 8 }
rule : { (0,0) + 1 } 100 { (-1,0,1) = 7 }
rule : { (0,0) + 1 } 100 { (-1,1,1) = 6 }
rule : { (0,0) + 1 } 100 { (0,-1,1) = 5 }
rule : { (0,0) + 1 } 100 { (0,1,1) = 4 }
rule : { (0,0) + 1 } 100 { (1,-1,1) = 3 }
rule : { (0,0) + 1 } 100 { (1,0,1) = 2 }
rule : { (0,0) + 1 } 100 { (1,1,1) = 1 }
rule : { (0,0) } 100 { t } 
